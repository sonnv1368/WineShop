  ...
  <legend>Tài khoản</legend>
    ...
    <table width="550" border="0" cellspacing="0" cellpadding="0" align="center" >  
      ...
      <?php
		...
		{
		?>
        <td colspan="7" width="40" align="center" valign="middle" style="border:solid 1px #CCCCCC"><font color="#FF0000" size="2" face="Tahoma"><strong>Không có tài khoản nào</strong></font></td>
	  <?php }
	  	else
		{
			$i=$trang*15;
			$sql1="select * from user limit $dong,15";
	...
	{
		$s_trang=$trang+1;
	echo "<a href='index.php?page=sx_tk&trang={$trang}'>{$s_trang}</a>&nbsp;";
	}?>
	</td></tr>
       <?php }
		}
