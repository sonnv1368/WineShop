...
<fieldset>
  <legend>Hỏi đáp</legend>
    <table width="750" border="0" cellspacing="0" cellpadding="0" align="center" style="border-collapse:collapse;" >
      <tr>
      	<td align="center" valign="middle" height="62"><font color="#0000ff" size="4" face="Tahoma"><strong>DANH SÁCH ĐƠN HÀNG</strong></font></td>
      </tr>
    </table>
    <table width="600" border="0" cellspacing="0" cellpadding="0" align="center"  >  
      ...
      <?php
		...
		{
			$tt=$_GET["tt"];
	  		$sql="select * from dondathang where trangthai=$tt order by maddh desc";
		}
		else
		{
		...
		{
		?>
        <td colspan="7" width="40" align="center" valign="middle" style="border:solid 1px #33CC00"><font color="#FF0000" size="2" face="Tahoma"><strong>Không có đơn đặt hàng nào</strong></font></td>
	  <?php }
	  	else
		{
			$i=$trang*15;
