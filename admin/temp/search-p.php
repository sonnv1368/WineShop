...
<?php
	{
		...
		}else
		{
			...
			$sql = mysql_query("select * from sanpham where tensp like '%$keyword%'");
		...
		<?php
			...
			{
				$i=$trang*15;
				$sql = mysql_query("select * from sanpham where tensp like '%$keyword%' LIMIT $dong,15") or die(mysql_error());
