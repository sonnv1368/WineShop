...
<fieldset>
  <legend>Tài khoản</legend>
    ...
    <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" >  
      <?php
		...
		}else
		{
			...
			$sql = mysql_query("select * from dondathang where ngaydat like '$keyword'");
      ...
      <?php
		$sql1 = mysql_query("select * from dondathang where ngaydat like '$keyword' LIMIT $dong,15") or die(mysql_error());
	...
	{
		$s_trang=$trang+1;
			echo "<a href='index.php?page=search-d&keyword={$keyword}&trang={$trang}'>{$s_trang}</a>&nbsp;";
	}?>
	</td></tr>
       <?php }
