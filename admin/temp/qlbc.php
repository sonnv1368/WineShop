  ...
  <legend>Đánh giá sản phẩm</legend>
    <table width="750" border="0" cellspacing="0" cellpadding="0" >
	  ...
	  <?php }
		...
		{
			$i=$trang*15;
			$sql = mysql_query("select * from danhgia order by (diem/dem) $ob LIMIT $dong,15") or die(mysql_error());
       ...
       <tr>
		...
		<script type="text/javascript">
            ...
            $('.basic').jRating({
                     step:false, //cho phep nua ngoi sao
	...
	{
		$s_trang=$trang+1;
	echo "<a href='index.php?page=qlbc&ob={$ob}&trang={$trang}'>{$s_trang}</a>&nbsp;";
	}?>
	</td></tr>
       <?php }
		}
